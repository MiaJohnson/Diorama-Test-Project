...
@dso_cache = dso_local local_unnamed_addr global [528 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2871982009682684067, ; hash 0x27db546be072e8a3, from name: Diorama
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Diorama.dll.so
		ptr null; void* handle (0x0)
	}, ; 76
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3522124094412852998, ; hash 0x30e11933ee528f06, from name: Diorama.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Diorama.dll.so
		ptr null; void* handle (0x0)
	}, ; 94
	...
	%struct.DSOCacheEntry {
		i64 4171378146468253655, ; hash 0x39e3b652c4114fd7, from name: libaot-Diorama
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Diorama.dll.so
		ptr null; void* handle (0x0)
	}, ; 115
	...
	%struct.DSOCacheEntry {
		i64 6901205314225132718, ; hash 0x5fc601ab4c6d54ae, from name: aot-Diorama.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Diorama.dll.so
		ptr null; void* handle (0x0)
	}, ; 171
	...
	%struct.DSOCacheEntry {
		i64 7212724450430460771, ; hash 0x6418beac4aaea363, from name: aot-Diorama
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Diorama.dll.so
		ptr null; void* handle (0x0)
	}, ; 181
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-CommunityToolkit.Maui.Markup.dll.so
		ptr null; void* handle (0x0)
	}, ; 209
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 17812366287340798066, ; hash 0xf7323cc3ae178072, from name: libaot-Diorama.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Diorama.dll.so
		ptr null; void* handle (0x0)
	}, ; 505
...
@.env.3 = private unnamed_addr constant [37 x i8] c"fb973d09-bde1-4589-ba47-371fb5578410\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.diorama\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-Diorama.dll.so\00", align 16
...
@.DSOCacheEntry.10_name = private unnamed_addr constant [43 x i8] c"libaot-CommunityToolkit.Maui.Markup.dll.so\00", align 16
